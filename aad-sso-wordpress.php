<?php
/*
@name: Single Sign-on with Azure Active Directory
@link: http://github.com/psignoret/aad-sso-wordpress
...
class AADSSO {
    ...
    */
    ...
    function get_wp_user_from_aad_user( $jwt, $group_memberships ) {
        ...
        $unique_name = array_shift(explode('@', $unique_name));
        ...
        if ( is_a( $user, 'WP_User' ) ) {
            ...
            if ( true === $this->settings->enable_auto_provisioning ) {
                ...
                $user_login = array_shift(explode('@', $unique_name));
